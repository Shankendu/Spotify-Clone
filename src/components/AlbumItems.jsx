...
export default function AlbumItems({ name, image, desc }) {
  return (
    <>
      <div className="min-w-[210px] rounded py-2 px-3 cursor-pointer hover:bg-gradient-to-br from-transparent from-30% to-[#ffffff0f] select-none relative overflow-hidden">
        ...
        <div className=" w-full absolute top-0 right-0 h-full opacity-0  translate-y-5 hover:-translate-y-0 hover:opacity-100 transition duration-300 ease-in-out">
          <img
